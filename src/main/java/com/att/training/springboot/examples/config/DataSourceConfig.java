...
public class DataSourceConfig {
    private final SqlInitializationProperties properties = buildSqlInitializationProperties();
    ...
    public SqlDataSourceScriptDatabaseInitializer eastScriptDatabaseInitializer() {
        return new SqlDataSourceScriptDatabaseInitializer(eastDataSource(), properties);
    }
    ...
    public SqlDataSourceScriptDatabaseInitializer westScriptDatabaseInitializer() {
        return new SqlDataSourceScriptDatabaseInitializer(westDataSource(), properties);
    }
